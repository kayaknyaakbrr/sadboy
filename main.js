;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA NYET','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'WOI', 'HABIS',  'INI', 'SEPERTINYA ADA SESUATU', 'PENCET LAGI', 'GUA GA BOHONG KOK', 'PENCET LAGI', 'AKU TAHU KAMU PASTI KESEL', 'HEHE', 'JANJI', 'INI TERAKHIR', 'PENCET LAGI', 'AYO SEMANGAT', 'KAMU PASTI BISA', 'KURANG EFFORT PENCET ITU', 'AYO NYET', 'IYA INI BENER TERAKHIR KOK', 'YOWES NIH', 'I', 'HATE', 'YOU ', 'FUCK BUAT U', 'HEHE', 'MUKA LU KAYA MONYET', 'BYE BITCH']
